...
*/
/*
 * This script simply modifies Micks original code to set 2 NES Ports and 2 SNES ports
 * A0/A1 - NES
 * A2/A3 - SNES
 * *** WARNING *** this will also disable the CDC serial connection and you will not be able 
 *                 to program the arduino without applying GND and RST
 */
...
#define GAMEPAD_COUNT 4      // NOTE: No more than TWO gamepads are possible at the moment due to a USB HID issue.
...
/*
 * Modified the original controller types to assume A0/A1 are NES ports and A2/A3 are SNES ports
 */
